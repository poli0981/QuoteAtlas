...
| date-holidays                                                                                  | ISC                                              |
| Tauri + official plugins _(desktop/Android, Phase 3+)_                                         | MIT OR Apache-2.0                                |
| Fonts: Be Vietnam Pro, Lora, Noto Serif JP / SC / TC / KR _(+ later Naskh Arabic, Serif Thai)_ | SIL OFL 1.1                                      |
| Rust crates (transitive, `src-tauri`) _(Phase 3+)_                                             | MIT / Apache-2.0 — full list via `cargo license` |
